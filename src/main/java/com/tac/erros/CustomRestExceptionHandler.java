...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleObjectNotFound(
	    ...
	    ApiError apiError = new ApiError(HttpStatus.INTERNAL_SERVER_ERROR, error, ex.getLocalizedMessage());
	    
	    return new ResponseEntity<Object>(apiError, new HttpHeaders(), apiError.getStatus());
	}
	
	@ExceptionHandler({ IdAlreadyExistException.class })
	public ResponseEntity<Object> handleIdAlreadyExist(
			ObjectNotFoundException ex, WebRequest request) {
	    
		String error = "Id already exists on database";
